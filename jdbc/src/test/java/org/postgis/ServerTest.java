...
public class ServerTest {
    ...
    private static final String JDBC_DRIVER_CLASS_NAME = "com.edb.Driver";
	...
	public void testServer() throws Exception {
        ...
        if (testWithDatabase) {
            ...
            ((com.edb.PGConnection)connection).addDataType("geometry", PGgeometry.class);
            ((com.edb.PGConnection)connection).addDataType("box3d", PGbox3d.class);
